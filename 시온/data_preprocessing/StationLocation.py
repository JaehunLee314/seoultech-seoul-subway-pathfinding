...
master = pd.read_csv("dataset/Seoul_Station_Master.csv", encoding="cp949")
...
master_1to5.to_csv("dataset/station_location/subway_1to5_master.csv", index=False, encoding="utf-8")
...
# ──────────────────────────────────────────────────────────────────────────
# 2-1. CSV 불러오기
line1 = pd.read_csv("dataset/Metropolitan_1Line_Station_Location.csv", encoding="cp949")
...
# 2-3. CSV로 저장
line1.to_csv("dataset/station_location/subway_line1_coords.csv", index=False, encoding="utf-8")
...
# ──────────────────────────────────────────────────────────────────────────
# 3-1. CSV 불러오기
line5 = pd.read_csv("dataset/Metropolitan_5Line_Station_Location.csv", encoding="cp949")
...
# 3-3. CSV로 저장
line5.to_csv("dataset/station_location/subway_line5_coords.csv", index=False, encoding="utf-8")
